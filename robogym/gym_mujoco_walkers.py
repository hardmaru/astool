...
import numpy as np
import os, sys
from robogym.generate_mujoco_xml import generate_ant_xml
...
class AugmentAnt(RoboschoolForwardWalkerMujocoXML):
    ...
    def __init__(self): # need to be able to reset this at every "reset"
        RoboschoolForwardWalkerMujocoXML.__init__(self, "ant_test.xml", "torso", action_dim=8, obs_dim=28, power=2.5)
    def alive_bonus(self, z, pitch):
...
class AugmentHumanoid(RoboschoolForwardWalkerMujocoXML):
